...
export const NAV_ITEMS: NavItemDef[] = [
  ...
  { key: "athlete_knowledge_base", label: "Knowledge Base",   section: "Training" },
  ...
  { key: "coach_knowledge_base",   label: "Knowledge Base",   section: "Coach" },
  ...
  { key: "admin_knowledge_base",   label: "Knowledge Base",   section: "Admin" },
