...
export type FunctionalSessionFormData = {
  description: string;
  activity: string;
  subtype: string;
...
interface FunctionalSessionFormProps {
  initialData?: Partial<FunctionalSessionFormData>;
  generatedNamePreview?: string;
  loadingGeneratedNumber?: boolean;
  onSave: (data: FunctionalSessionFormData) => void;
  onCancel: () => void;
  isSaving?: boolean;
...
function createEmptyForm(): FunctionalSessionFormData {
  return {
    description: "",
    activity: "",
    subtype: "",
...
export function FunctionalSessionForm({
  initialData,
...
}: FunctionalSessionFormProps) {
  const [form, setForm] = useState<FunctionalSessionFormData>(
  ...
  function updateForm<K extends keyof FunctionalSessionFormData>(
    field: K,
    value: FunctionalSessionFormData[K],
  ) {
    setForm((current) => ({
      ...current,
      [field]: value,
