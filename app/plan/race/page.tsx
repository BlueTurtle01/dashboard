      ...
      <div className="space-y-5">
        ...
        <section className="rounded-2xl border border-zinc-200 bg-white p-5">
          ...
          <div className="mt-4 divide-y divide-zinc-100">
            ...
            <Link href="/plan/race/reviews" className="flex items-center justify-between gap-4 py-4">
              <span className="min-w-0">
                <span className="block text-sm font-semibold text-zinc-950">Race Reviews</span>
                <span className="mt-1 block text-sm text-zinc-600">
                  Read runner ratings and race-day notes for {race.name}.
                </span>
              </span>
              <span className="shrink-0 text-xl text-zinc-400" aria-hidden="true">
                &rsaquo;
